...
The HTML Element is used in dynamic data situations (e.g. component/template authoring) where you're pulling content from that database or a component prop that contains HTML (a rich text field, for example).
