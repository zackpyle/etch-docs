...
<div class="page-sections">
  {#loop this.acf.page_sections as section}
    ...
    {#if section.acf_fc_layout == 'hero_banner'}
      <section data-etch-element="section" class="section section--hero">
    ...
    {#if section.acf_fc_layout == 'text_block'}
      <section data-etch-element="section" class="section section--text">
    ...
    {#if section.acf_fc_layout == 'image_gallery'}
      <section data-etch-element="section" class="section section--gallery">
        <div class="gallery">
